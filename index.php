...
<body class="bg-light"><div class="container mt-5">
    ...
    <form action="insertar.php" method="POST" class="card p-3 mb-4 shadow-sm">
        <div class="input-group">
            <input type="text" name="nombre" class="form-control" placeholder="Nombre (Punto de inyección)" required>
    ...
    <table class="table table-white shadow-sm">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <button class="btn btn-warning btn-sm" data-bs-toggle="modal" data-bs-target="#e<?php echo $f['id']; ?>">Editar</button>
                    <a href="eliminar.php?id=<?php echo $f['id']; ?>" class="btn btn-danger btn-sm">Eliminar</a>
                </td>
            </tr>
            <div class="modal fade" id="e<?php echo $f['id']; ?>" tabindex="-1">
                <div class="modal-dialog"><form action="editar.php" method="POST" class="modal-content">
                    <div class="modal-body">
                        <input type="hidden" name="id" value="<?php echo $f['id']; ?>">
                        <input type="text" name="nombre" class="form-control" value="<?php echo $f['nombre']; ?>">
                    </div>
                    <div class="modal-footer"><button class="btn btn-primary">Actualizar</button></div>
                </form></div>
            </div>
            <?php } ?>
        </tbody>
